<?php /* Template Name: Reserver du materiel */ ?>
			...
			<div class="grid-100 tablet-grid-100 mobile-grid-100 grid-parent">
				<nav id="menu-services">
					<ul>
						...
						<li  class="active"><a href="#">Réserver du matériel</a></li>
						<li><a href="<?php echo get_permalink(63581); ?>">Proposer une offre de concert</a></li>
					</ul>
				</nav>
			</div>
		</div>
				...
				<div class="clearfix">
					<div class="information-service grid-60 tablet-grid-100 mobile-grid-100">
						...
						<div class="liste-bouton">
							...
							<?php 							
							$file_piano = get_field('formulaire_piano');
							if( $file_piano ): ?>
								<a href="<?php echo $file_piano['url']; ?>" class="voir-plus fond-noir medium" target="_blank">Prêt du piano</a>
							<?php endif; ?>
	
							<?php
							$file_form = get_field('formulaire_fichier');
							if( $file_form ): ?>
								<a href="<?php echo $file_form['url']; ?>" class="voir-plus fond-noir medium" target="_blank">Prêt de matériel</a>
							<?php endif; ?>
						
							<?php 							
							$file_lu = get_field('formulaire_lu');
							if( $file_lu ): ?>
								<a href="<?php echo $file_lu['url']; ?>" class="voir-plus fond-noir medium" target="_blank">Prêt du «LÜ»</a>
							<?php endif; ?>
							
							<?php $file_handisport = get_field('formulaire_handisport');
							if($file_handisport): ?>
								<a href="<?php echo $file_handisport['url']; ?>" class="voir-plus fond-noir medium" target="_blank">Matériel Handisport</a>
							<?php endif; ?>
