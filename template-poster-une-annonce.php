<?php /* Template Name: Poster une annonce */ ?>
		...
		<div class="wrapper clearfix">
			<div class="grid-100 tablet-grid-100 mobile-grid-100 grid-parent">
				<nav id="menu-services">
					<ul>
						<li class="active"><a href="#">Poster une annonce gratuitement</a></li>
			...
			<div class="grid-100 tablet-grid-100 mobile-grid-100 grid-parent">
				...
				<div class="clearfix">
					<div class="information-service grid-60 tablet-grid-100 mobile-grid-100">
						<img class="picto" src="/wp-content/themes/agenda/img/picto-annonce.svg" alt="picto services">
						<h1><?php the_title(); ?></h1>
						<?php the_field('video'); ?>
